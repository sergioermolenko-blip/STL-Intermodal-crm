...
- [ ] View — добавить в форму создания
- [ ] **Modal — добавить в форму редактирования**
- [ ] Controller — добавить валидацию (если нужно)
- [ ] UI — добавить в таблицу/карточку
- [ ] CRUD — добавить в отправку данных
- [ ] Tests — обновить unit тесты
- [ ] Tests — обновить e2e тесты (создание + редактирование)
